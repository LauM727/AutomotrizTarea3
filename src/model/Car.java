...
public class Car extends Vehicle implements Gasoline, Electric, Hybrid{
  ...
  public Car(int basePrice, int soldPrice, String marca, String model, int cylinderCapacity, int km, boolean isNew, String id, int type, int doors, boolean isPolarized) {
